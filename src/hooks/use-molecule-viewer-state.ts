...
export function useMoleculeViewerState(options: UseMoleculeViewerStateOptions) {
  ...
  const [prevSelectedEntry, setPrevSelectedEntry] = useState<PdbEntry | null>(null);
  if (selectedEntry !== prevSelectedEntry) {
    setPrevSelectedEntry(selectedEntry);
    if (selectedEntry) {
  ...
  const [prevSelectedEvalStructure, setPrevSelectedEvalStructure] = useState<(EvalPdbStructure & { isBlast?: boolean }) | null>(null);
  if (selectedEvalStructure !== prevSelectedEvalStructure) {
    setPrevSelectedEvalStructure(selectedEvalStructure);
