...
export function WeeklyPdbTable({
  ...
  const renderMethodBadge = (method: string | null) => {
    ...
    return (
      <span className={`inline-flex items-center justify-center min-w-[62px] px-1.5 py-0.5 rounded text-[9px] font-medium border ${colors.bg} ${colors.text} ${colors.border} method-badge ${badgeClass}`}>
        {label}
      </span>
    );
  };
